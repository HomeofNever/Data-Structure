...
int main() {
    ...
    cout << "Begin remove element test" << endl;
    Vec<int> ele(10, 0);
    cout << remove_matching_element(ele, 1) << endl;
    ele.print();
    cout << remove_matching_element(ele, 0) << endl;
    ele.print();
    ele.push_back(1);
    ele.push_back(2);
    ele.push_back(3);
    ...
    ele.push_back(5);
    ele.print();
    cout << remove_matching_element(ele, 3) << ':' << remove_matching_element(ele, 1) << endl;
    ele.print();
    cout << "Finish removing element test" << endl;

    cout << "Begin Push Test" << endl;
    Vec<int> many;
